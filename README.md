...
> - Pi: install the [pi coding agent](https://github.com/earendil-works/pi-coding-agent) (`npm install -g @earendil-works/pi-coding-agent`) and make sure `pi` is on your `PATH`
...
- Pi provider: [providers-pi.md](./docs/user/providers-pi.md)
